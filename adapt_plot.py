...
open_file = open("w_adaptation_increase.txt", "r")
string_inc = open_file.read()
open_file.close()

open_file = open("w_adaptation_decrease.txt", "r")
string_dec = open_file.read()
open_file.close()
...
pylab.figure("FI Curve, External Current vs. Synaptic Weight")
...
pylab.plot(list_inc_a, J_list, "or", label="Inc_Adapting", linewidth=4)
pylab.plot(list_dec_a, J_list, "ob", label="Dec_Adapting", linewidth=4)
pylab.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)


pylab.title("FI Curve, External Current vs. Synaptic Weight")
